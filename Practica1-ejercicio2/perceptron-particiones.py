...
for indice_particion, (indices_entrenamiento, indices_prueba) in enumerate(skf.split(entradas, salidas)):
    ...
    print(f"Entrenamiento finalizado para {nombre_conjunto_datos} - Partición {indice_particion + 1}.")
    ...
    print(f"{nombre_conjunto_datos} - Partición {indice_particion + 1} -Precisión: {precision * 100:.2f}%")
...
grafico_3d(datos_entrenamiento, etiquetas_entrenamiento, pesos_entrenados, sesgo_entrenado, f'Patrones y Plano de Separación (3D) - {nombre_conjunto_datos}')